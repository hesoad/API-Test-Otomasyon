...
public class C14_Post_ExpectedDataVeJsonPathIleAssertion {
   ...
   String url=" https://restful-booker.herokuapp.com/booking";
        ...
        JSONObject rezTarihJsonObject=new JSONObject();

        //ic taraftan baslayara objeyi olusruruz.
        rezTarihJsonObject.put("checkin","2021-06-01");
        rezTarihJsonObject.put("checkout","2021-06-10");

        //en ustten requestbody si olusturmaya baslayacagiz.

        requestBody.put("firstname","Ahmet");
        requestBody.put("lastname", "Bulut");
        requestBody.put("totalprice",500);
        requestBody.put("depositpaid",false);
        requestBody.put( "bookingdates",rezTarihJsonObject);
        ...
        //3-request gönderip, dönen response kaydet.
        ...
        //ikinci yazilan actual =====> responsedan gelir ancak biz burada JsonPath opjesine kolaylik olsun diye cevirdik. responseJsonPath
